...
class Cartaportedetails extends Migration {

    public function up() {
        // Cartaportedetails
        $this->forge->addField([
            'id' => ['type' => 'int', 'constraint' => 11, 'unsigned' => true, 'auto_increment' => true],
            'idCartaPorte' => ['type' => 'int', 'constraint' => 11, 'null' => true],
        ...
        $this->forge->createTable('cartaportedetails', true);
    }

    public function down() {
        $this->forge->dropTable('cartaportedetails', true);
    }
}
